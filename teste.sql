...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Jun-2020 às 00:04
...
(13, 'Allan', 'Daniel', 'AllanDaniel', 358677, '338801819', '', '1984-06-04', 2147483647, 2147483647, 'oliveirasantos.allan@gmail.com', '', 'Rua Dinorah da ConceiÃ§Ã£o Braga', '79', 'Sobrado', 'Morada do Sol', 8820490, 'Mogi das Cruzes', 'SP', '', 'C:fakepathperfis-comportamentais.jpg', '1553a61c7332aa125c196b8b26e18f2d', '1553a61c7332aa125c196b8b26e18f');
...
--
ALTER TABLE `perg`
  MODIFY `idPerg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
